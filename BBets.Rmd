...
The average profit is 280 dollars.
...
print(uci)
```
The fair odds in the function of Brownlows earnings should be an average of $4.40. 
...
If there are a total of 28 people in class, then the 2:1 bet would be fair.
